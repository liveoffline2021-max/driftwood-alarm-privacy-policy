...
**Children’s Privacy**  
Driftwood Alarm Clock is not intended for children under 13, and we do not knowingly collect data from children.
...
**خصوصية الأطفال**  
تطبيق Driftwood Alarm Clock غير مخصص للأطفال دون سن 13، ونحن لا نجمع بيانات من الأطفال عن عمد.
...
Driftwood Alarm Clock не е предназначено за деца под 13 години и ние съзнателно не събираме данни от деца.
...
**শিশুদের গোপনীয়তা**  
Driftwood Alarm Clock 13 বছরের কম বয়সী শিশুদের জন্য নয়, এবং আমরা শিশুদের থেকে সচেতনভাবে ডেটা সংগ্রহ করি না।
...
### Børns privatliv
Driftwood Alarm Clock er ikke beregnet til børn under 13 år, og vi indsamler ikke bevidst data fra børn.
...
**Kinderschutz**  
Driftwood Alarm Clock ist nicht für Kinder unter 13 Jahren gedacht, und wir sammeln wissentlich keine Daten von Kindern.
...
**Απόρρητο Παιδιών**  
Το Driftwood Alarm Clock δεν προορίζεται για παιδιά κάτω των 13 ετών και δεν συλλέγουμε εν γνώσει μας δεδομένα από παιδιά.
...
**Privacidad Infantil**  
Driftwood Alarm Clock no está dirigido a menores de 13 años y no recopilamos datos de niños a sabiendas.
...
### Lasten yksityisyys
Driftwood Alarm Clock ei ole tarkoitettu alle 13-vuotiaille lapsille, emmekä tietoisesti kerää lapsilta tietoja.
...
Driftwood Alarm Clock n’est pas destiné aux enfants de moins de 13 ans et nous ne collectons pas sciemment leurs données.
...
**बच्चों की गोपनीयता**  
Driftwood Alarm Clock 13 वर्ष से कम उम्र के बच्चों के लिए नहीं है, और हम जानबूझकर बच्चों का डेटा संग्रह नहीं करते हैं।
...
### Privatnost djece
Driftwood Alarm Clock nije namijenjen djeci mlađoj od 13 godina, i ne prikupljamo svjesno podatke od djece.
...
A Driftwood Alarm Clock nem gyermekeknek, 13 év alattiaknak készült, és nem gyűjtünk tudatosan adatokat gyermekektől.
...
Driftwood Alarm Clock-ը նախատեսված չէ 13 տարեկանից փոքր երեխաների համար, և մենք գիտակցաբար չենք հավաքագրում տվյալներ երեխաներից:
...
### Persónuvernd barna  
Driftwood Alarm Clock er ekki ætlað börnum yngri en 13 ára og við söfnum ekki meðvitað gögnum frá börnum.
...
**Privacy dei bambini**  
La Driftwood Alarm Clock non è destinata a bambini sotto i 13 anni e non raccogliamo dati consapevolmente dai bambini.
...
**子供のプライバシー**  
Driftwood Alarm Clockは13歳未満の子供向けではなく、子供のデータを意図的に収集することはありません。
...
**어린이 개인정보 보호**  
Driftwood Alarm Clock는 13세 미만 어린이를 대상으로 하지 않으며, 어린이 데이터를 의도적으로 수집하지 않습니다.
...
### Vaikų privatumas  
Driftwood Alarm Clock nėra skirtas vaikams iki 13 metų, ir mes sąmoningai nerenkame duomenų iš vaikų.
...
Driftwood Alarm Clock не е наменет за деца под 13 години и не собираме свесно податоци од деца.
...
### Barns personvern  
Driftwood Alarm Clock er ikke ment for barn under 13 år, og vi samler ikke bevisst inn data fra barn.
...
Driftwood Alarm Clock is niet bedoeld voor kinderen onder de 13 jaar en wij verzamelen bewust geen gegevens van kinderen.
...
**Prywatność dzieci**  
Driftwood Alarm Clock nie jest przeznaczony dla dzieci poniżej 13 roku życia i nie zbieramy świadomie danych od dzieci.
...
O Driftwood Alarm Clock não se destina a crianças menores de 13 anos, e não coletamos dados de crianças conscientemente.
...
Driftwood Alarm Clock nie je určený pre deti mladšie ako 13 rokov a vedome nezbierame údaje od detí.
...
### Zasebnost otrok  
Driftwood Alarm Clock ni namenjen otrokom, mlajšim od 13 let, in zavestno ne zbiramo podatkov od otrok.
...
### Barns integritet  
Driftwood Alarm Clock är inte avsedd för barn under 13 år, och vi samlar inte medvetet in data från barn.
...
Driftwood Alarm Clock не призначений для дітей до 13 років, і ми навмисно не збираємо дані дітей.
...
**隐私政策 – Driftwood Alarm Clock**

**数据收集**
虽然我们不会收集您的个人数据，但本应用使用 **Google AdMob** 来展示广告。AdMob 可能会收集以下信息：

* 设备标识符（例如广告 ID）
* 使用数据（例如应用交互、会话时长）

这些信息用于提供个性化广告并改进广告效果。我们无法访问您的个人详细信息，也不会自行共享这些信息。

**位置数据**
Driftwood Alarm Clock 可选择访问您设备的大致位置，以提供本地天气信息。

如果您授予权限，应用可能会将您选择的城市及相关位置坐标存储在您的设备本地，以改善您的使用体验并显示天气更新。

位置访问完全是可选的，用户也可以手动输入城市。我们不会出售您的位置数据。
...
对于位于欧洲经济区（EEA）、英国和瑞士的用户，您可以随时通过 [Google 的同意撤销页面](https://www.google.com/appconsent) 查看或更改您对此应用的广告同意设置。

对于 Google 的一般广告设置，您还可以访问 [Google 广告设置](https://www.google.com/settings/ads) ，以管理您在所有 Google 服务中的广告个性化设置。

**儿童隐私**
Driftwood Alarm Clock 不适用于 13 岁以下儿童，我们也不会故意收集儿童的数据。

**第三方服务**
本应用使用 Google AdMob 等第三方服务，这些服务拥有其自身的隐私政策。有关更多信息，请参阅 [Google 隐私政策](https://policies.google.com/privacy)。

**崩溃报告与诊断**

Driftwood Alarm Clock 使用 Firebase Crashlytics（由 Google 提供的崩溃报告服务）来帮助识别应用崩溃、稳定性问题和技术错误。
...
这些信息仅用于改进应用的可靠性、稳定性和性能。我们不会使用崩溃报告数据来识别用户个人身份。
...
**电子邮件：** [contact@liveoffline.ca](mailto:contact@liveoffline.ca)
